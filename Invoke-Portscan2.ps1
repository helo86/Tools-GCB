    ...
    PROCESS {
        ...
        function Get-TopPort
        {
            ...
            [int[]] $topPortList = @(80,23,443,21,3389,110,445,139,143,53,135,3306,8080,22
                        ...
                        8300,8383,9003,9081,9099,9200,9418,9575,9878,9898,9917,10003,10180,10215,
                        ...
                        6009,7004,44443,109,687,726,1461,2035,4125,6006,7201,9103,125,481,683,903,
